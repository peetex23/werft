...
@section('title', 'Pembelian Aset Tetap Kredit')
@section('page_heading','Form Pembelian Aset Tetap Kredit')
        ...
        <form role="form" class="form form-horizontal" method="POST" action="{{url('/pembelian_aset')}}"  autocomplete="off">
            ...
            <div class="panel-footer">
                <div class="button-group">
                    ...
                    <a class="btn btn-danger" href="{{ url('/pembelian_aset/tetap/kredit')}}" >Batal</a>
                </div>
            </div>
